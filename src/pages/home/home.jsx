                ...
                <div className="footer-div">
                    ...
                    <div className="contacts"> 
                        ...
                        <div className="socials">
                            <h3>CONTACTS: </h3>
                            <a href="https://github.com/sweta1308"><i class="fa-brands fa-github fa-lg"></i> Github</a>
                            <a href="https://twitter.com/AgarwallaSweta"><i class="fa-brands fa-twitter fa-lg"></i> Twitter</a>
                            <a href="https://www.linkedin.com/in/sweta-agarwalla-45aa2324a/"><i class="fa-brands fa-linkedin fa-lg"></i> LinkedIn</a>
                        </div>
                    </div>
