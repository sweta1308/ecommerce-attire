...
export const getCartItemsHandler = function (
  this: any,
  schema: any,
  request: any,
) {
...
export const addItemToCartHandler = function (
  this: any,
  schema: any,
  request: any,
) {
...
export const removeItemFromCartHandler = function (
  this: any,
  schema: any,
  request: any,
) {
  ...
  try {
    ...
    userCart = userCart.filter((item: any) => item._id !== productId)
    this.db.users.update({ _id: userId }, { cart: userCart })
    return new Response(200, {}, { cart: userCart })
  } catch (error) {
    return new Response(
...
export const updateCartItemHandler = function (
  this: any,
  schema: any,
  request: any,
) {
