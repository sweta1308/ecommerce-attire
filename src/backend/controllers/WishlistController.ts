...
export const getWishlistItemsHandler = function (
  this: any,
  schema: any,
  request: any,
) {
...
export const addItemToWishlistHandler = function (
  this: any,
  schema: any,
  request: any,
) {
...
export const removeItemFromWishlistHandler = function (
  ...
  try {
    ...
    userWishlist = userWishlist.filter((item: any) => item._id !== productId)
    this.db.users.update({ _id: userId }, { wishlist: userWishlist })
    return new Response(200, {}, { wishlist: userWishlist })
  } catch (error) {
    return new Response(
